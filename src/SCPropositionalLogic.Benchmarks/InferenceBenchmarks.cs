...
using AiAModernApproachResolutionKB = SCPropositionalLogic.Inference.ResolutionKnowledgeBase_FromAIaMA;
...
namespace SCPropositionalLogic.Benchmarks
{
    ...
    public class InferenceBenchmarks
    {
        ...
        private readonly ILinqKnowledgeBase<MyModel> nonCompilingTruthTable = new LinqKnowledgeBase<MyModel>(new TruthTableKnowledgeBase_NonCompiling());
